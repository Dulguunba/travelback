...
const createTravel = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { name, travelCompany, duration, adultPrice, childPrice, IsIncludeFoodCheck, IsIncludeFoodPriceCheck, foodNumber, foodPrice, IsIncludeTrafficCheck, IsIncludeTrafficPriceCheck, trafficPrice, } = req.body;
    console.log(name, travelCompany, duration, adultPrice, childPrice, IsIncludeFoodCheck, IsIncludeFoodPriceCheck, foodNumber, foodPrice, IsIncludeTrafficCheck, IsIncludeTrafficPriceCheck, trafficPrice);
    try {
